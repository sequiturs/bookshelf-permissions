...
module.exports = {
  ...
  configure: function(opts) {
    ...
    var useWithBookshelfAdvancedSerializationPlugin =
      opts.useWithBookshelfAdvancedSerializationPlugin || false;
    var DefaultDoesNotHavePermissionError =
      opts.DefaultDoesNotHavePermissionError || BookshelfPermissionsPluginPermissionError;
    ...
    return function(Bookshelf) {
      Bookshelf.Model = Bookshelf.Model.extend({
         ...
         */
        checkHasPermission: BluebirdPromise.method(function(permission, accessor, opts) {
          ...
          var unsupportedProvidedOptions = _.difference(_.keys(opts),
          ...
          return this._getFirstAuthorizedAuthorizationLevelForPermission(permission, accessor)
            ...
            .then(function(result) {
              ...
              if (result.isAuthorized) {
                ...
                if (opts.requiredFirstAuthorizedAuthorizationLevel) {
                  if (result.authorizationLevelName === opts.requiredFirstAuthorizedAuthorizationLevel) {
                    return this;
                  } else {
              ...
              // been specified
              if (opts.annotateErrHasReadPermission) {
